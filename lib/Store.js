...
(function() {
  ...
  Store = (function() {
    ...
    function Store(options) {
      ...
      if ((_base = this.options).eventsCollection == null) {
        _base.eventsCollection = EVENTS_COLLECTION;
      }
      if ((_base1 = this.options).options == null) {
        _base1.options = {};
      }
    ...
    Store.prototype.remove = function(eventId, callback) {
      /*
          Removes a one-time event.
          @return {Boolean} whether the event was removed or not.
      */

      return this.EventModel.remove({
        _id: eventId
      }, function(err) {
        if (err != null) {
          return callback(err);
